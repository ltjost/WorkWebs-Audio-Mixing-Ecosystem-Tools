ECHO OFF
color 06
set scriptver=Easter Holy Week-WING 2026 v2060326a v14a-I
...
echo %tempstringx%
set tempstring=".      ***  Build WING "  %scriptver% " base 20260326a  ***"
set tempstringx=%tempstring:"=%
echo %tempstringx%
set tempstring="."
set tempstringx=%tempstring:"=%
...
set  myTrackVar.cPIANO=1
set  myTrackVar.cPIANO.type=ch

set  myTrackVar.cKICK=2
set  myTrackVar.cKICK.type=ch

set  myTrackVar.cSNARE=3
set  myTrackVar.cSNARE.type=ch

set  myTrackVar.cOHL=4
set  myTrackVar.cOHL.type=ch

set  myTrackVar.cOHR=5
set  myTrackVar.cOHR.type=ch

set  myTrackVar.cAG=6
set  myTrackVar.cAG.type=ch

set  myTrackVar.cEG=7
set  myTrackVar.cEG.type=ch

set  myTrackVar.cBG=8
set  myTrackVar.cBG.type=ch

set  myTrackVar.cTIMPHI=9
set  myTrackVar.cTIMPHI.type=ch

set  myTrackVar.cTIMP2=10
set  myTrackVar.cTIMP2.type=ch

set  myTrackVar.cTIMP3=11
set  myTrackVar.cTIMP3.type=ch

set  myTrackVar.cTIMPLO=12
set  myTrackVar.cTIMPLO.type=ch

set  myTrackVar.cPERC1=13
set  myTrackVar.cPERC1.type=ch

set  myTrackVar.cPERC2=14
set  myTrackVar.cPERC2.type=ch

set  myTrackVar.cPERC3=15
set  myTrackVar.cPERC3.type=ch

set  myTrackVar.cHORNfrt=16
set  myTrackVar.cHORNfrt.type=ch

set  myTrackVar.cHORNbk=17
set  myTrackVar.cHORNbk.type=ch

set  myTrackVar.cBONEfrt=18
set  myTrackVar.cBONEfrt.type=ch

set  myTrackVar.cBONEmid=19
set  myTrackVar.cBONEmid.type=ch

set  myTrackVar.cBONEbk=20
set  myTrackVar.cBONEbk.type=ch

set  myTrackVar.cTPTfrt=21
set  myTrackVar.cTPTfrt.type=ch

set  myTrackVar.cTPTmid=22
set  myTrackVar.cTPTmid.type=ch

set  myTrackVar.cCLARINETfrt=23
set  myTrackVar.cCLARINETfrt.type=ch

set  myTrackVar.cOBOE=24
set  myTrackVar.cOBOE.type=ch

set  myTrackVar.cFLUTEfrt=25
set  myTrackVar.cFLUTEfrt.type=ch

set  myTrackVar.cFLUTEbk=26
set  myTrackVar.cFLUTEbk.type=ch

set  myTrackVar.cVIOLINfrt=27
set  myTrackVar.cVIOLINfrt.type=ch

set  myTrackVar.cVIOLINbk=28
set  myTrackVar.cVIOLINbk.type=ch

set  myTrackVar.cVIOLA=29
set  myTrackVar.cVIOLA.type=ch

set  myTrackVar.cCELLO=30
set  myTrackVar.cCELLO.type=ch

set  myTrackVar.cTPTbk=31
set  myTrackVar.cTPTbk.type=ch

set  myTrackVar.cTUBA=32
set  myTrackVar.cTUBA.type=ch

set  myTrackVar.cCLARINETbk=33
set  myTrackVar.cCLARINETbk.type=ch

set  myTrackVar.cCLARINETH=34
set  myTrackVar.cCLARINETH.type=ch

set  myTrackVar.cCHAN35=35
set  myTrackVar.cCHAN35.type=ch

set  myTrackVar.cCHAN36=36
set  myTrackVar.cCHAN36.type=ch

set  myTrackVar.cCHAN37=37
set  myTrackVar.cCHAN37.type=ch
...
set  myTrackVar.cALTPC=40
set  myTrackVar.cALTPC.type=ch
